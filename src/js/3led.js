{
  ...
  "steps" : {
		...
		"3led_slow_speed__gateway":
		{
			...
			"Buttons":
			[ 
				["3led_slow_speed__gateway_tryethernet","Yes, wi-fi"],
				["3led_slow_speed__gateway__checkcsl","Yes, wired or both"]
			]
		},
		"3led_slow_speed__gateway_tryethernet":
		{
			...
			"Buttons":
			[ 
				["3led_slow_speed__gateway__checkcsl","Yes"],
				["3led_slow_speed__gateway__wifi","The client does not use ethernet"],
				["3led_slow_speed__gateway__wifi","No"]
			]
		},
		"3led_slow_speed__gateway__wifi":
		{
			...
			[ 
			  ...
			  ["3led_slow_speed__gateway__wifi_radio_interference","All clients are affected"]
			]
		},
		"3led_slow_speed__gateway__checkcsl":
		{
			...
			[ 
				...
				["3led_factory_reset","wi-fi, acceptable"],
				["3led_factory_reset","wired - both, acceptable"]
			]
		},
		...
		"3led_slow_speed__gateway__wifi_congestion":
		{
			...
			[
				...
				["3led_slow_speed__gateway__checkcsl","No"]
			]
		},
